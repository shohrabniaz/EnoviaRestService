...
public class DeleteFileInADocumentConsumer extends ConsumerModel<DocumentResponseModel> {

    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(DeleteFileInADocumentConsumer.class);
    String docId;
    String fileId;

    public DeleteFileInADocumentConsumer(String docId, String fileId) {
        this.docId = docId;
        this.fileId = fileId;
    }
...
//        "https://dsd2v21xspace.plm.valmet.com/3dspace/resources/v1/modeler/documents/5D2B6C1200000D8861277B8A000086E6/files"
        ...
        String aFilesUrl = PropertyReader.getProperty("ds.service.url.for.a.file.in.a.document");
        String aFilesInADocument = threedUrl + aFilesUrl;
        String aFileResource = MessageFormat.format(aFilesInADocument, this.docId, this.fileId);
        LOGGER.info(aFileResource);
