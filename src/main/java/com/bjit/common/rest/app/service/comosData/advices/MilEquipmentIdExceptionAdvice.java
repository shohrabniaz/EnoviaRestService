...
public class MilEquipmentIdExceptionAdvice {
    ...
    @ExceptionHandler(MilEquipmentIdSearchException.class)
    public String MilEquipmentIdExceptionHandle(MilEquipmentIdSearchException exp) {
