 ...
 * @author BJIT
 */
public class CommonBOMValidator implements IBomValidator {

    private static final org.apache.log4j.Logger BOM_IMPORT_VALIDATOR_LOGGER = org.apache.log4j.Logger.getLogger(CommonBOMValidator.class);
    private static final String POSITIVE_INTEGER_REGEX = "[1-9]\\d*";
    private static final Pattern POSITIVE_INTEGER_PATTERN = Pattern.compile(POSITIVE_INTEGER_REGEX);

    public CommonBOMValidator() {
    }
    ...
    public BOMDataCollector bomValidationAndDataCollection(Context context, BusinessObjectUtil businessObjectUtil, BusinessObjectOperations businessObjectOperations, CreateBOMBean createBOMBean, CommonBOMImportParams commonBomImportVariables) throws IOException, MatrixException, Exception {
        ...
        BOM_IMPORT_VALIDATOR_LOGGER.info("Parent BOM validation process has been started");
        ...
        BOM_IMPORT_VALIDATOR_LOGGER.info("Parent BOM validation process has been completed");
        BOM_IMPORT_VALIDATOR_LOGGER.info("Lines validation process has been started");
        ...
        for (HashMap<String, String> lineDataMap : createBOMBean.getLines()) {
            ...
            BOM_IMPORT_VALIDATOR_LOGGER.debug(tempChildTNR.toString() + " Position " + childPosition);
            tempChildTNR = null;
        ...
        BOM_IMPORT_VALIDATOR_LOGGER.info("Lines validation process has been completed");
    ...
    protected HashMap<String, String> prepareAttributeNameValueMap(List<Attribute> relAttributeList, HashMap<String, String> lineDataMap, String childName, String parentName) {
    ...
    protected HashMap<String, String> searchChildItem(Context context, TNR childTNR, CommonSearch commonSearch, String childUniqueKey, HashMap<String, String> childInfoIdMap) throws Exception {
        ...
        if (!childInfoIdMap.containsKey(childUniqueKey)) {
            try {
                ...
                BOM_IMPORT_VALIDATOR_LOGGER.info(" | Search | " + childTNR.getName() + " | " + DateTimeUtils.getDuration(start_child_find_time, end_child_find_time));
    ...
    protected BusinessObject searchParentItem(Context context, TNR parentTNR, CommonSearch commonSearch) throws MatrixException, Exception {
        try {
            ...
            BOM_IMPORT_VALIDATOR_LOGGER.info(" | Search | " + parentTNR.getName() + " | " + DateTimeUtils.getDuration(start_find_time, end_find_time));
