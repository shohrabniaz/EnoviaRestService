...
@Log4j
@Service
@Qualifier("LNTaskSort")
public class LNTaskSort implements ITaskSort {
    @Override
    public List<ComosTaskBean> sortTasksAndMileStonesData(List<ComosTaskBean> taskAndMileStoneData) {
        ...
        log.info("Tasks before sorting " + json.serialize(taskAndMileStoneData));
        ...
        taskAndMileStoneData.forEach((ComosTaskBean taskOrMileStone) -> {
            ...
            log.info("Parent Activity" + parentActivity);
