 ...
 * @author BJIT
 */
public final class HagForsBOMCreationProcessor implements IBOMCreationProcessor {

    private static final org.apache.log4j.Logger HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER = org.apache.log4j.Logger.getLogger(HagForsBOMCreationProcessor.class);
    ...
    public HagForsBOMCreationProcessor() {
    }

    public HagForsBOMCreationProcessor(Context context, HashMap<ParentInfo, HashMap<String, ChildInfo>> parentChildInfoMap, CommonBOMImportParams commonBomImportVariables) {
        ...
        for (ParentInfo parentInfoKey : parentChildInfoMap.keySet()) {
            ...
            for (String childNamePositionKey : childInfoMap.keySet()) {
                ...
                if (!NullOrEmptyChecker.isNullOrEmpty(childInfo.getRelIDList())) {
                    ...
                    HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER.debug("Modifying relationship from parent :  " + parentName + " to child : " + childInfo.getChildTNR().toString());
                    ...
                    if (childQuantityFromRequest > numOfExisitingChild) {
                        ...
                        HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER.debug("Requested new duplicate connection : No of duplicate connection " + noOfNewConnection);
                ...
                if (!commonBomImportVariables.errorInStructure && NullOrEmptyChecker.isNullOrEmpty(childInfo.getRelIDList())) {
                    HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER.debug("Creating relationship from parent ::  " + parentName + " to child :: " + childInfo.getChildTNR().getName());
            ...
            HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER.info(" | Data | Parent | " + parentName + " | Total child=" + numberOfChildInTheBOM);
            HAGFORS_BOM_CREATION_AND_SPLITTING_PROCESSOR_LOGGER.info(" | Process Time | Single BOM | " + parentName + " | " + total_BOM_process_time);
