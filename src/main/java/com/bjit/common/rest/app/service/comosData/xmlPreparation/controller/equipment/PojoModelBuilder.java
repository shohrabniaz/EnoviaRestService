...
//import com.bjit.common.rest.app.service.comosData.xmlPreparation.model.comosxml.PositionSize;
...
//    }
//
//    public static RFLVPMItem populateLogicalPipeTypeData(String type, String code, String description, String name, String discipline, Long sequence) {
//        RFLVPMItem rflvpmItem = new RFLVPMItem();
//        rflvpmItem.setValue(sequence.toString());
//        rflvpmItem.setType(getType(type));
//        rflvpmItem.setMandatory(setReferenceItemsMandatoryAttribute(name));
...
//    }
//
//    public static RFLVPMItem populateValveTypeData(String comosType, String code, String description, String name, String discipline, Long sequence) {
//        RFLVPMItem rflvpmItem = new RFLVPMItem();
//        rflvpmItem.setValue(sequence.toString());
//        rflvpmItem.setType(getType(comosType));
//        rflvpmItem.setMandatory(setReferenceItemsMandatoryAttribute(name));
