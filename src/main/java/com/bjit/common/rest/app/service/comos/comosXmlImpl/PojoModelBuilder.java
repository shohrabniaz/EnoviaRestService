package com.bjit.common.rest.app.service.comos.comosXmlImpl;

import com.bjit.common.rest.app.service.comos.models.comosxml.RFLVPMItem;
import com.bjit.common.rest.app.service.comos.models.comosxml.Attribute;
import com.bjit.common.rest.app.service.comos.models.comosxml.BoundingBox;
import com.bjit.common.rest.app.service.comos.models.comosxml.TextGraphicProperties;
import com.bjit.common.rest.app.service.comos.models.comosxml.Mandatory;
import com.bjit.common.rest.app.service.comos.models.comosxml.Relation;
import com.bjit.common.rest.app.service.comos.models.comosxml.PositionSize;
import com.bjit.common.rest.app.service.comos.models.defaultData.DefaultMap;

public class PojoModelBuilder {
    public static RFLVPMItem populateLogicalReferenceTypeData(String type, String name, String discipline, Long sequence) {
    ...
    public static RFLVPMItem populateLogicalPipeTypeData(String type, String code, String name, String discipline, Long sequence) {
        RFLVPMItem rflvpmItem = new RFLVPMItem();
        rflvpmItem.setValue(sequence.toString());
        rflvpmItem.setType(getType(type));
        rflvpmItem.setMandatory(setReferenceItemsMandatoryAttribute(name));
        rflvpmItem.setOwner(getOwner());
        rflvpmItem.setvName(getVName(code));
        rflvpmItem.setRevision(getRevision());
        rflvpmItem.setvIsFlexible(getVIsFlexible());
        rflvpmItem.setOriginated(getOriginatedDate());
        rflvpmItem.setPolicy(getPolicy());
        rflvpmItem.setModified(getModifiedDate());
        rflvpmItem.setCurrent(getCurrent());
...
//    }
    ...
    public static RFLVPMItem populateLogicalReferenceTypeData(String comosType, String code, String name, String discipline, Long sequence) {
        RFLVPMItem rflvpmItem = new RFLVPMItem();
        rflvpmItem.setValue(sequence.toString());
        rflvpmItem.setType(getType(comosType));
        rflvpmItem.setMandatory(setReferenceItemsMandatoryAttribute(name));
