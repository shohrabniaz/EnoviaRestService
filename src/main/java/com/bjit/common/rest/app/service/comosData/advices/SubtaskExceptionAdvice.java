...
public class SubtaskExceptionAdvice {
    ...
    @ExceptionHandler(SubtasksStructureException.class)
    public String DeliStatusListExceptionHandle(SubtasksStructureException exp) {
