...
public class EquipmentControllerExceptionAdvice {
    ...
    @ExceptionHandler(EquipmentStructureException.class)
    public String EquipmentStructureExceptionHandle(EquipmentStructureException exp) {
