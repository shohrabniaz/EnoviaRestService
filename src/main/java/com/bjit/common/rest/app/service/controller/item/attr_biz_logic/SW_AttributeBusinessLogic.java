 ...
 * @author BJIT
 */
public class SW_AttributeBusinessLogic extends MV_AttributeBusinessLogic {

    private static final Logger logger = Logger.getLogger(SW_AttributeBusinessLogic.class);
