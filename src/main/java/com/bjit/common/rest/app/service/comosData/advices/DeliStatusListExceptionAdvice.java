...
public class DeliStatusListExceptionAdvice {
    ...
    @ExceptionHandler(DeliStatusListException.class)
    public String DeliStatusListExceptionHandle(DeliStatusListException exp) {
