 ...
 * @author BJIT
 */
public class SP_AttributeBusinessLogic extends MV_AttributeBusinessLogic {

    private static final Logger logger = Logger.getLogger(SP_AttributeBusinessLogic.class);
