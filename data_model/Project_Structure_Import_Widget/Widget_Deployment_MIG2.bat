...
SET mcs_dir=D:\DassaultSystemes\R2018x\3DSpace\Code
SET backup_file_location=D:\DassaultSystemes\Widget_Backup

REM Dont change the following variable 'deployment_environment'
SET deployment_environment=MIG2

SET widget_title=Project_Structure_Import
SET widget_folder_name=ProjectStructureImportUX
