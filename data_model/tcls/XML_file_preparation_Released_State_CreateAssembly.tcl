...
eval {
	...
	set triggerType [ split [ mql temp query bus "eService Trigger Program Parameters" "StateChangeTrigger" * select id dump ] , ]
	...
	mql add bus "eService Trigger Program Parameters"  StateChangeTrigger -\
