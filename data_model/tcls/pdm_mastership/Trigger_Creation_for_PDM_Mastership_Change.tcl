...
tcl;
eval {
	set fp_LogFile [open "XML_file_preparaion_on_released_for_CreateAssembly_type.log" "a"]
	...
	set triggerType [ split [ mql temp query bus "eService Trigger Program Parameters" "MastershipChangeStateChangeTrigger" "mcsrev" select id dump ] , ]
	...
	mql add bus "eService Trigger Program Parameters"  MastershipChangeStateChangeTrigger mcsrev\
	...
	"eService Method Name" "mastershipChangeCommonStateChangeFileGeneration"\
