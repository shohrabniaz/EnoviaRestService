define("VALCON/ReportingPrintingUX/PreferenceConfiguration", [], function() {
    var preferenceConfiguration = {
        ...
        "RP_PREF_NAME_REPORT_FORMAT_MBOM_EBOM": "ReportFormatMBOMEBOM",
        ...
        "RP_PREF_LABEL_REPORT_FORMAT_MBOM_EBOM": "Report Format MBOM EBOM",

        "RP_PREF_REPORT_FORMAT_PREFERRED_VALUE": "pdf",
        ...
        "RP_PREF_REPORT_FORMAT_OPTS": {
            "mbom": {
                opts: [{ "value": "pdf", "label": "PDF" }, { "value": "xls", "label": "XLS" }],
                defaultValue: "pdf",
                value: "pdf"
            },
            "ebom": {
            ...
            "spr": {
                opts: [{ "value": "txt", "label": "TXT" }],
                defaultValue: "txt",
                value: "txt"
            }
        },
        "RP_PREF_REPORT_FORMAT_CHECK": ["mbom", "ebom"],
        "RP_PREF_REPORT_FORMAT_VALUE_CHECK": ["pdf", "xls"],
