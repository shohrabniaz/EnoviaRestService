...
$serviceUrl = 'https://dsd2v21integration.plm.valmet.com/EnoviaRestService/vsix/translation/title/update';
$logFile = 'G:\Scheduler\EnoviaTitleUpdate\EnoviaTitleUpdate.log'
$lockFile = 'G:\Scheduler\EnoviaTitleUpdate\EnoviaTitleUpdate.lock'
