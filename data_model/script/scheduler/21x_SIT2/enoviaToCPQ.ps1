...
Invoke-WebRequest -Uri 'https://dsd3v21integration.plm.valmet.com/EnoviaRestService/bomExportToCPQ' | Out-File -Append G:\Integrations\EnoviaToCPQ\CPQ_Scheduler.log
#Start-Sleep -s 15
