...
public class emxCustomRevisionTrigger_mxJPO {
    ...
    private void writeDataToALogFile(String[] args) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("G:\\Integrations\\pdm-mastership\\requestDataFromPDMRevision.txt"));
    ...
    public void mastershipChangeFileGeneration(Context ctx, String[] args) throws Exception {
        ...
        String mastershipChangeModelOwnerAttribute = "coexusr1";

        if (masterShipChangeModel.mastership.equalsIgnoreCase(mastershipChangeModelMastershipAttribute) && masterShipChangeModel.hasInterface && masterShipChangeModel.owner.equalsIgnoreCase(mastershipChangeModelOwnerAttribute)) {
