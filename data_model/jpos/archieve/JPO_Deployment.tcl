...
eval {
	...
	set iRetCode [ catch {
		...
		backupProgram "CheckInCheckOutUtil" $fp_LogFile
		backupProgram "CloneObjectUtil" $fp_LogFile
		backupProgram "CreateRelationship" $fp_LogFile
		backupProgram "UpdateRelationshipAttribute" $fp_LogFile

		addProgram "CheckInCheckOutUtil" "CheckInCheckOutUtil_mxJPO.java" $fp_LogFile
		addProgram "CloneObjectUtil" "CloneObjectUtil_mxJPO.java" $fp_LogFile
		addProgram "CreateRelationship" "CreateRelationship_mxJPO.java" $fp_LogFile
		addProgram "UpdateRelationshipAttribute" "UpdateRelationshipAttribute_mxJPO.java" $fp_LogFile

		compileProgram "CheckInCheckOutUtil" $fp_LogFile
		compileProgram "CloneObjectUtil" $fp_LogFile
		compileProgram "CreateRelationship" $fp_LogFile
		compileProgram "UpdateRelationshipAttribute" $fp_LogFile

		verifyJPO "CheckInCheckOutUtil" $fp_LogFile $fp_err_LogFile
		verifyJPO "CloneObjectUtil" $fp_LogFile $fp_err_LogFile
		verifyJPO "CreateRelationship" $fp_LogFile $fp_err_LogFile
		verifyJPO "UpdateRelationshipAttribute" $fp_LogFile $fp_err_LogFile
